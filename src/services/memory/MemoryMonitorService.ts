...
export const DEFAULT_MEMORY_CONFIG: MemoryMonitorConfig = {
  ...
  jsHeapSampleIntervalMs: getEnvNumber('MEMORY_JS_HEAP_SAMPLE_INTERVAL_MS', 5000),
  ...
  resourceSampleIntervalMs: getEnvNumber('MEMORY_RESOURCE_SAMPLE_INTERVAL_MS', 10000),
